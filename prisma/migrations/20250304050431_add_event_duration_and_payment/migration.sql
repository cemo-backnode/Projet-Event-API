/*
  ...
  - Added the required column `heureDebut` to the `Event` table without a default value. This is not possible if the table is not empty.
  - Added the required column `heureFin` to the `Event` table without a default value. This is not possible if the table is not empty.
